      ...
      <nav className="flex-1">
        ...
        <div className="py-3">
          <button
            ...
            className={`flex items-center w-[263px] h-[58px] px-[36px] text-[20px] font-normal transition-colors ${
              currentPage === 'dashboard'
                ? 'bg-[#5D71E25E] bg-opacity-37 text-[#3C0BA8]'
        ...
        <div className="px-6">
          <button
            onClick={() => onPageChange('arsip')}
            className={`flex items-center w-full px-3 py-2 text-[16px] rounded-md mb-1 transition-colors ${
              currentPage === 'arsip'
          ...
          <button
            onClick={() => onPageChange('ocr-demo')}
            className={`flex items-center w-full px-3 py-2 text-[16px] rounded-md mb-1 transition-colors ${
              currentPage === 'ocr-demo'
                ? 'bg-purple-100 text-purple-700'
                : 'text-gray-700 hover:bg-gray-100'
            }`}
          >
            <svg className="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
              <path fill="currentColor" d="M2.5 3A1.5 1.5 0 0 0 1 4.5v.793c.026.009.051.02.076.032L7.674 8.51c.206.1.446.1.652 0l6.598-3.185A.755.755 0 0 1 15 5.293V4.5A1.5 1.5 0 0 0 13.5 3h-11Z"/>
              <path fill="currentColor" d="M15 6.954L8.978 9.86a2.25 2.25 0 0 1-1.956 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z"/>
            </svg>
            OCR Demo
          </button>
          
          <button
            onClick={() => onPageChange('test-connection')}
            className={`flex items-center w-full px-3 py-2 text-[16px] rounded-md mb-1 transition-colors ${
              currentPage === 'test-connection'
                ? 'bg-purple-100 text-purple-700'
                : 'text-gray-700 hover:bg-gray-100'
            }`}
          >
